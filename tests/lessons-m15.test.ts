...
describe("M15 lessons", () => {
  ...
  checkLesson(bundle, "M15-02", {
    ...
    cardsMin: 10,
    maxSeconds: 45,
    prerequisites: ["M15-01"],
  });
  checkLesson(bundle, "M15-03", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
    cardsMin: 10,
    maxSeconds: 45,
    prerequisites: ["M15-02"],
  });
  checkLesson(bundle, "M15-04", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
    cardsMin: 10,
    maxSeconds: 45,
    prerequisites: ["M15-03"],
  });
  checkLesson(bundle, "M15-05", {
    vocabMin: 12,
    dialogueMin: 8,
    listening: 6,
    quiz: 8,
