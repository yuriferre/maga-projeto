...
describe("M23 lessons", () => {
  ...
  checkLesson(bundle, "M23-02", {
    ...
    cardsMin: 10,
    maxSeconds: 45,
    prerequisites: ["M23-01"],
  });
  checkLesson(bundle, "M23-03", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
    cardsMin: 10,
    maxSeconds: 60,
    prerequisites: ["M23-02"],
  });
  checkLesson(bundle, "M23-04", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
    cardsMin: 10,
    maxSeconds: 60,
    prerequisites: ["M23-03"],
  });
  checkLesson(bundle, "M23-05", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
