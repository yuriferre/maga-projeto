...
describe("M24 lessons", () => {
  ...
  checkLesson(bundle, "M24-02", {
    ...
    cardsMin: 10,
    maxSeconds: 45,
    prerequisites: ["M24-01"],
  });
  checkLesson(bundle, "M24-03", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
    cardsMin: 10,
    maxSeconds: 60,
    prerequisites: ["M24-02"],
  });
  checkLesson(bundle, "M24-04", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
    cardsMin: 10,
    maxSeconds: 60,
    prerequisites: ["M24-03"],
  });
  checkLesson(bundle, "M24-05", {
    vocabMin: 12,
    dialogueMin: 6,
    listening: 6,
    quiz: 8,
